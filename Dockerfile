# IBM Integration Bus with Toolkit

FROM ubuntu:16.04

LABEL maintainer "Payment Engine Team"
...
RUN mkdir /opt/ibm && \
    curl http://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/integration/10.0.0.23-IIB-LINUX64-DEVELOPER.tar.gz \
